...
MAX_BOUND_LNG_LAT = [5.67066192626953, 45.1028500272485, 5.8938217163086, 45.2760944159253]

# for test
# MAX_BOUND = [45.1824338559252, 5.71986436843872, 45.1833602226135, 5.72116255760193]
# MAX_BOUND_LNG_LAT = [ 5.727185,45.165826, 5.727652,45.166028]
    ...
    def bound_filter(self, geo: Geojson, bound: List[float] = None) -> dict:
        ...
        geo.features = \
            [feature
             ...
             if feature.position.in_bound(bound)]
