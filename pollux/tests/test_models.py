...
class ModelsTest(TestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(self.lamp1.power_impact(day=True), 150)
        self.assertEqual(self.lamp1.power_impact(day=False), 135)
        ...
        self.assertEqual(self.lamp2.aligned_power_impact(self.lamp1, day=True), 300)
        self.assertEqual(self.lamp2.aligned_power_impact(self.lamp1, day=False), 270)
        self.assertEqual(self.lamp1.aligned_power_impact(self.lamp2, day=True), 150)
